...
@section('content')
    ...
    <div class="about">
        ...
        <div class="about__content">
            ...
            <div class="hr_decoration">
                <p>Soy Quiromasajista de profesión y artesana, dibujante e ilustradora por vocación. Creadora intuitiva
                    de
                ...
                <p>Nací en un hogar biracial, cosa que me ha enriquecido bellamente, y crecí en la provincia de
                    Alicante.
                    Afortunadamente en la actualidad, vivo en una casita de campo rodeada de naturaleza.</p>
                <p>En estos últimos años,
                    por el trabajo mi estilo de vida ha implicado mucho movimiento constante, algo que me encanta, y
                    aunque
